...
function init() {
    try {
        ...
        bind('listAdvancedBtn', ' 'click', function() { openAdvanced('clickeditor'); });

        // Профиль
',        bind('editProfileBtn', 'click', openEditProfile);
        bind('profileAvatar', 'click', openEdit resetProfile);
        bind('AvatarsaveProfileBtn', 'click', saveProfileChanges);

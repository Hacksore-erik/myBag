...
var WHATS_NEW = {
    ...
    color1: '#5ec7ff', color2: '#3a86ff',
    items: [
        { icon: '✈️', title: 'Вкладка «Поездка»', desc: 'Вся информация о поездке собрана в одном месте' },
        { icon: '🏨', title: 'Брони и рейсы', desc: 'Сохраняйте отель и номер рейса, проверяйте статус на Яндексе' },
        { icon: '📝', title: 'Заметки', desc: 'Wi-Fi, коды, телефоны — всё под рукой в чек-листе' },
        { icon: '🌤️', title: 'Новая погода', desc: 'Компактный блок с раскрытием на 5 дней' },
        { icon: '📊', title: 'Сводка поездки', desc: 'Прогресс сбора, обратный отсчёт и погода на одном экране' },
        { icon: '🎨', title: 'Обновлённый дизайн', desc: 'Единый стиль карточек, аккуратные формы' }
    ],

...
var WHATS_NEW = {
    ...
    subtitle: 'Мы сделали myBag удобнее',
    color1: '#ff9a5a', color2: '#ff6b8a',
    items: [
        { icon: '⚡', title: 'В 2 раза больше вещей', desc: 'Список стал компактным, всё влезает на один экран' },
        { icon: '📋', title: 'Списки теперь видно', desc: 'У каждого своя иконка и прогресс' },
        { icon: '➕', title: 'Одна кнопка для всего', desc: 'Плавающая кнопка + для добавления вещей и списков' },
        { icon: '✂️', title: 'Списки прямо в поездке', desc: 'Добавляйте и удаляйте списки без перехода в другие экраны' },
        { icon: '🎨', title: 'Свежий вид', desc: 'Новый дизайн форм, заголовки проще, даты в одну строку' },
        { icon: '✨', title: 'Приятные жесты', desc: 'Свайпы стали плавнее, без глюков и лишних эффектов' }
    ],
...
var TIPS_CATEGORIES = [
    { id: 'packing', name: 'Упаковка', emoji: '🧳', color1: '#ff9a5a', color2: '#ff6b8a', desc: 'Как упаковать чемодан',
      tips: [
        { icon: '👕', text: '<strong>Скручивайте в рулоны.</strong> Экономит место и меньше мнётся' },
        { icon: '👟', text: '<strong>Обувь вниз, носки внутрь.</strong> Заполняет пустоты, держит форму' },
        { icon: '🧴', text: '<strong>Жидкости в зип-пакет.</strong> Под крышку плёнка, чтобы не протекло' },
        { icon: '👖', text: '<strong>Тяжёлое на дно.</strong> Чемодан не переворачивается и не падает' },
        { icon: '🎒', text: '<strong>Мелочи по мешочкам.</strong> Провода по типам, не путаются' },
        { icon: '🪥', text: '<strong>Щётку в колпачок.</strong> Гигиеничнее и не пачкает сумку' }
      ] },
    { id: 'docs', name: 'Документы', emoji: '📄', color1: '#5ec7ff', color2: '#3a86ff', desc: 'Что взять из документов',
      tips: [
        { icon: '🛂', text: '<strong>Копия паспорта отдельно.</strong> Плюс фото в облаке, на всякий случай' },
        { icon: '✈️', text: '<strong>Скриншот и распечатка.</strong> Посадочные и брони даже без сети' },
        { icon: '💳', text: '<strong>Две карты в разных сумках.</strong> И немного наличных про запас' },
        { icon: '🩺', text: '<strong>Страховка на бумаге.</strong> Иногда просят печатный вариант' },
        { icon: '🎫', text: '<strong>Билеты офлайн.</strong> Доступ без интернета, сеть пропадает' },
        { icon: '📱', text: '<strong>Номер посольства.</strong> Запишите на случай проблем за рубежом' }
      ] },
    { id: 'tech', name: 'Техника', emoji: '📱', color1: '#a06bff', color2: '#6b8cff', desc: 'Про гаджеты в дороге',
      tips: [
        { icon: '🔌', text: '<strong>Powerbank 20000 мАч.</strong> Хватает на 3-4 дня, один вместо пяти' },
        { icon: '🧵', text: '<strong>Провода в стяжки.</strong> Не путаются в сумке и не рвутся' },
        { icon: '🎧', text: '<strong>Наушники в кейсе.</strong> Не поцарапаются в кармане' },
        { icon: '💻', text: '<strong>Ноутбук в чехле.</strong> Отдельно от жидкостей и обуви' },
        { icon: '🔋', text: '<strong>Авто-синк отключить.</strong> В роуминге телефон проживёт вдвое дольше' },
    ...
    { id: 'clothes', name: 'Одежда', emoji: '👕', color1: '#4ecb71', color2: '#2f9c53', desc: 'Как собрать гардероб',
      tips: [
        { icon: '🎨', text: '<strong>Правило капсулы.</strong> 3 низа, 3 верха и куртка = 9 образов' },
        { icon: '👖', text: '<strong>Максимум две пары обуви.</strong> Одна в дорогу, вторая в чемодан' },
        { icon: '🧥', text: '<strong>Слои для холода.</strong> Термобельё, флиска и куртка' },
        { icon: '🌧️', text: '<strong>Компактный дождевик.</strong> Складывается до размера кулака' },
        { icon: '👕', text: '<strong>Тёмные цвета практичнее.</strong> В дороге меньше видны пятна' },
        { icon: '👙', text: '<strong>Запасной комплект носков.</strong> Пригодится на всякий случай' }
      ] },
    { id: 'security', name: 'Безопасность', emoji: '🔒', color1: '#d6336c', color2: '#ff5e8a', desc: 'Как защитить имущество',
      tips: [
        { icon: '🎒', text: '<strong>Рюкзак на грудь.</strong> В толпе за спиной легко стать целью' },
        { icon: '💰', text: '<strong>Деньги в 2-3 местах.</strong> Кошелёк, носки, внутренний карман' },
        { icon: '📷', text: '<strong>Фото чемодана.</strong> Поможет при потере, сохраните в облако' },
        { icon: '🔐', text: '<strong>Кодовый замок.</strong> Надёжнее простого навесного' },
        { icon: '📞', text: '<strong>Маршрут близким.</strong> Отели, рейсы, время прилёта' },
        { icon: '🚕', text: '<strong>Только официальное такси.</strong> Не соглашайтесь на «быстрее и дешевле»' }
      ] },
    { id: 'lifehacks', name: 'Лайфхаки', emoji: '💡', color1: '#ffd166', color2: '#f4a261', desc: 'Полезные мелочи',
      tips: [
        { icon: '🧊', text: '<strong>Замороженная бутылка.</strong> И вода, и охлаждение для сумки' },
        { icon: '🧴', text: '<strong>Спрей вместо ролла.</strong> Дезодорант-спрей не протечёт' },
        { icon: '🧦', text: '<strong>Носки в обувь.</strong> Заполняют пустоту и экономят место' },
        { icon: '🍫', text: '<strong>Сникерс в кармане.</strong> Спасёт от голода, если нет кафе' },
        { icon: '💊', text: '<strong>Мини-аптечка.</strong> Обезболивающее, пластырь, активированный уголь' },
        { icon: '🧴', text: '<strong>Пробники косметики.</strong> Легче больших флаконов и не жалко выкинуть' },
        { icon: '📌', text: '<strong>Булавка на молнию.</strong> Быстрый «замок» от воришек в метро' },
        { icon: '🛍️', text: '<strong>Пустой мешок для сувениров.</strong> Складывается и занимает мало места' }
      ] }
];

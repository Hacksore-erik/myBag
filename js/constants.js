...
var WHATS_NEW = {
    emoji: '🎯',
    title: 'Что нового',
    subtitle: 'myBag стал удобнее и чище',
    color1: '#4ecb71', color2: '#2f9c53',
    items: [
        { icon: '🎠', title: 'Переключение поездок', desc: 'Листайте активные поездки прямо на вкладке «Поездка»' },
        { icon: '📊', title: 'Компактный виджет', desc: 'Вся сводка о поездке уместилась в аккуратную карточку' },
        { icon: '⚙️', title: 'Настройки отдельно', desc: 'Шестерёнка в профиле — все настройки в одном месте' },
        { icon: '📝', title: 'Заметки на месте', desc: 'Заметки теперь только на экране «Поездка», без дублей' },
        { icon: '🧹', title: 'Стало чище', desc: 'Убрали лишнее — приложение работает быстрее' },
        { icon: '🌤️', title: 'Аккуратная погода', desc: 'Погода стала компактнее, но осталась информативной' }
    ],

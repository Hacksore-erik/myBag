...
var WHATS_NEW = {
    ...
    items: [
        ...
        { icon: '📋', title: 'Списки теперь видно', desc: 'У каждого списка своя иконка и прогресс — сразу понятно где что' },
        { icon: '➕', title: 'Одна кнопка для всего', desc: 'Плавающая кнопка + — добавление вещей и списков в один тап' },
        ...
        { icon: '✨', title: 'Приятные жесты', desc: 'Свайпы стали плавнее — без глюков и визуальных артефактов' }
    ],
...
var ONBOARDING_SLIDES = [
    ...
    {icon:'✈️',bg:'✈️',title:'Создавайте поездки',text:'Выбирайте базовый тип + свои списки. Объединяйте до 3 активных поездок.'},
